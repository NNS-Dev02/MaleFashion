...
namespace MaleFashion.Controllers
{
    public class CheckOutController : Controller
    {
        ...
        public ActionResult SaveToDataBase(KhachHang x)
        {
            ...
            using(var context = new MaleFashion_Connect())
            {
                using (DbContextTransaction trans = context.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        x.maKH = string.Format("KH{0:mmssffff}", DateTime.Now);
                        x.ngayDat = DateTime.Now;
                        ...
                        d.soDH = string.Format("DH{0:mmssffff}", DateTime.Now);
                        d.maKH = x.maKH;
                        d.ngayDat = x.ngayDat;    d.ngayGH = DateTime.Now.AddDays(2);
                        d.daKichHoat = false;
                        d.vanChuyen = false;
                        d.ghiChu = x.ghiChu;
